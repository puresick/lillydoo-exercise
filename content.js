		...
		fragments: [
			{
				...
				icon: require("./assets/icons/lillydoo-your-trialbox-icon.svg")
,
			...
			},
			{
				...
				icon: require("./assets/icons/lillydoo-your-flexibility-icon.svg"),
				link: {
			...
			},
			{
				...
				icon: require("./assets/icons/lillydoo-your-subscription-icon.svg"),
